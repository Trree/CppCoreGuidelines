...
这一系列的核心指导是针对现代C++，C++14，同时也是对将来的提升和视为ISO技术规范。
目标是帮助C++程序员写出更加简单高效，可维护的代码。
...
所有的C++程序员，同时包含了[C程序员](./cpl-c-style-programming.md)。

## <a name="SS-aims"></a>In.aims: Aims

这篇文档的目的是帮助开发者采用现代C++(C++11, C++14, C++17)，实现一个更加统一的代码库。
